    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-header">
                <h4 class="card-title"> <strong>Startup Programs</strong></h4>
                <p class="card-category"> Analyze and manage the programs set to run automatically at system startup to optimize performance.</p>
            </div>
            <div>
                <form>
                        ...
                        <table class="table table-border">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['search'])) {
                                    ...
                                    $query = "SELECT * FROM startup_programs where CONCAT(hostname) LIKE '%$filtervalues%'";
