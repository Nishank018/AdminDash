...
<div class="content">
        <div class="row">
          ...
          <div class="card-header">
                <h4 class="card-title"> <strong>Sytstem Information</strong></h4>
        ...
        <div class="card mt-4">
            <div class="card-body">
                <table class="table table-border">
                    <thead>
                        <tr>
                            ...
                            <th>USBSTOR REG</th>
                            <th>RDP enabled</th>
                            <th>Kaspersky installed</th>
                            <th>FW domain profile</th>
                            <th>FW privet profile</th>
                            <th>FW public profile</th>
                        </tr>
                    ...
                    <?php
                        if(isset($_GET['search']))
                        {
                            ...
                            $query = "SELECT * FROM status  where CONCAT(hostname) LIKE '%$filtervalues%'";
                ...
                <td>
                    <?= $items['USBSTOR_REG'] == 3 ? 'Yes' : ($items['USBSTOR_REG'] == 4 ? 'No' : 'Unknown'); ?>
                </td>
                <td><?=$items['RDP_enabled']; ?></td>
                <td><?=$items['kaspersky_installed']; ?></td>
                <td><?=$items['FW_domain_profile']; ?></td>
                <td><?=$items['FW_private_profile']; ?></td>
                <td><?=$items['FW_public_profile']; ?></td>
            </tr>
                                    </tr>
                                    <?php
