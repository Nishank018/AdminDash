    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-header">
                <h4 class="card-title"> <strong>Open Ports</strong></h4>
                <p class="card-category">: Identify and manage open network ports on systems to ensure security and connectivity.</p>
            </div>
            <div>
                <form>
                        ...
                        <table class="table table-border">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['search'])) {
                                    ...
                                    $query = "SELECT * FROM open_ports where CONCAT(hostname) LIKE '%$filtervalues%'";
