    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-header">
                <h4 class="card-title"> <strong>User Accounts</strong></h4>
                <p class="card-category"> Manage user accounts and permissions, ensuring secure access to systems and applications./p>
            </div>
            <div>
                <form>
                        ...
                        <table class="table table-border">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['search'])) {
                                    ...
                                    $query = "SELECT * FROM user_accounts where CONCAT(hostname) LIKE '%$filtervalues%'";
